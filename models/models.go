...
//创表
func init(){
	orm.RegisterDataBase("default","mysql","root:root@tcp(127.0.0.1:3306)/lovehome2?charset=utf8",30)

	orm.RegisterModel(new(User),new(OrderHouse),new(Facility),new(Area),new(HouseImage),new(House))
